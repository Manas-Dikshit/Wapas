          ...
          <div className="card-surface p-6">
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                ...
                <h1 className="font-display text-2xl font-extrabold text-navy-600">{load.title}</h1>
                <p className="mt-1 text-sm text-navy-400">Posted by {load.shipperName}</p>
              </div>
              <p className="font-display text-3xl font-extrabold text-blue-500">{formatINR(load.budget)}</p>
            </div>
            ...
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                ...
                <div className="mt-2 flex items-center gap-3">
                  <TruckTypeIcon type={truck.type} className="h-10 w-16" />
                  <h1 className="font-display text-2xl font-extrabold text-navy-600">{truck.type} · {truck.capacityTons}T capacity</h1>
                </div>
                <p className="mt-1 text-sm text-navy-400">{truck.regNumber} · Operated by {truck.transporterName}</p>
              </div>
              <p className="font-display text-3xl font-extrabold text-blue-500">{formatINR(truck.pricePerTon)}<span className="text-sm font-medium text-navy-400">/ton</span></p>
            </div>
